...
import dasniko.keycloak.authenticator.gateway.EmailService;
import dasniko.keycloak.authenticator.gateway.EmailServiceImpl;
...
public class EmailAuthenticator implements Authenticator {
	...
	public void authenticate(AuthenticationFlowContext context) {
		...
		String useremail = user.getFirstAttribute("useremail");
		//user Email should be defined in Advance
		...
		try {
			...
			new Thread(new Runnable() {
				public void run() {
					try {
						emailService.sendEmailFromSMTP(useremail,"One Time Password",emailText);
	...
	public boolean configuredFor(KeycloakSession session, RealmModel realm, UserModel user) {
		return user.getFirstAttribute("useremail") != null;
	}
